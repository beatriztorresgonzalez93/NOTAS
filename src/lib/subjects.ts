export const FIXED_SUBJECTS = [
  ...
  {
    slug: "sistemas-electricos-neumaticos-hidraulicos",
    name: "Sistemas eléctricos, neumáticos e hidráulicos",
    order: 4,
  },
  {
  ...
  { slug: "ingles-negocios", name: "Inglés para los negocios", order: 7 },
] as const;
